...
import { Plus, Trash2, Clock, MessageSquare, UserPlus, ArrowRight } from "lucide-react";
...
export const CampaignWizard = () => {
  ...
  const [sequenceSteps, setSequenceSteps] = useState<SequenceStep[]>([
    { id: "1", type: "connection", content: "Hi {{firstName}}, I'd love to connect with you!" },
    { id: "2", type: "wait", days: 3 },
    { id: "3", type: "message", content: "Hi {{firstName}}, I noticed you work at {{company}}. I'd love to discuss how we can help your team." },
  ]);
